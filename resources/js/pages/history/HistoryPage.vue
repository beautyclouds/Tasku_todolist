                ...
                <div v-for="card in cards" :key="card.id"
                    ...
                    <div v-if="card.members" class="mb-2 flex items-center gap-2">
                        ...
                        <div class="flex -space-x-2">
                            <img v-for="member in card.members" :key="member.id"
                                :src="member.photo ? member.photo : `https://ui-avatars.com/api/?name=${member.name}`" :alt="member.name"
                    ...
                    <!-- Lihat Detail -->
                    <Link :href="`/history/${card.id}`" class="inline-block text-sm font-medium text-blue-600 hover:underline">
                    Lihat Detail
                    </Link>
                </div>
            </div>
