...
// Removing the 'props' definition as it's not used in the <script> block
// The props are directly accessible in the template.
defineProps({
    card: Object,
});
</script>
    ...
    <AppLayout>
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="items-center justify-between">
                ...
                <Link href="/history" class="text-gray-700 text-2xl font-bold hover:text-gray-900">
                ←
                </Link>
            </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <div v-for="member in card.members" :key="member.id"
                            ...
                            <img :src="member.photo ? member.photo : `https://ui-avatars.com/api/?name=${member.name}`"
                                :alt="member.name" class="h-8 w-8 rounded-full border-2 border-white shadow dark:border-gray-700 object-cover" />
